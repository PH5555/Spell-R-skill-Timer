...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_spell1_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkTime[0]) {
                    checkTime[0] = false;
                    setCoolDown(ad_spell1, txt_aspell1, (int) champLiine[3].getSpell1id(), 0);
                }
                else {
                    checkTime[0] = true;
                    setCoolDown(ad_spell1, txt_aspell1, (int) champLiine[3].getSpell1id(), 0);
        ...
        img_spell2_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkTime[1]) {
                    checkTime[1] = false;
                    setCoolDown(ad_spell2, txt_aspell2, (int) champLiine[3].getSpell2id(), 1);
                }
                else {
                    checkTime[1] = true;
                    setCoolDown(ad_spell2, txt_aspell2, (int) champLiine[3].getSpell2id(), 1);
        ...
        img_spell1_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkTime[2]) {
                    checkTime[2] = false;
                    setCoolDown(sup_spell1, txt_sspell1, (int) champLiine[4].getSpell1id(), 2);
                }
                else {
                    checkTime[2] = true;
                    setCoolDown(sup_spell1, txt_sspell1, (int) champLiine[4].getSpell1id(), 2);
        ...
        img_spell2_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkTime[3]) {
                    checkTime[3] = false;
                    setCoolDown(sup_spell2, txt_sspell2, (int) champLiine[4].getSpell2id(), 3);
                }
                else {
                    checkTime[3] = true;
                    setCoolDown(sup_spell2, txt_sspell2, (int) champLiine[4].getSpell2id(), 3);
        ...
        img_spell1_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkTime[4]) {
                    checkTime[4] = false;
                    setCoolDown(mid_spell1, txt_mspell1, (int) champLiine[2].getSpell1id(), 4);
                }
                else {
                    checkTime[4] = true;
                    setCoolDown(mid_spell1, txt_mspell1, (int) champLiine[2].getSpell1id(), 4);
        ...
        img_spell2_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkTime[5]) {
                    checkTime[5] = false;
                    setCoolDown(mid_spell2, txt_mspell2, (int) champLiine[2].getSpell2id(), 5);
                }
                else {
                    checkTime[5] = true;
                    setCoolDown(mid_spell2, txt_mspell2, (int) champLiine[2].getSpell2id(), 5);
        ...
        img_spell1_j.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkTime[6]) {
                    checkTime[6] = false;
                    setCoolDown(jungle_spell1, txt_jspell1, (int) champLiine[1].getSpell1id(), 6);
                }
                else {
                    checkTime[6] = true;
                    setCoolDown(jungle_spell1, txt_jspell1, (int) champLiine[1].getSpell1id(), 6);
        ...
        img_spell2_j.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkTime[7]) {
                    checkTime[7] = false;
                    setCoolDown(jungle_spell2, txt_jspell2, (int) champLiine[1].getSpell2id(), 7);
                }
                else {
                    checkTime[7] = true;
                    setCoolDown(jungle_spell2, txt_jspell2, (int) champLiine[1].getSpell2id(), 7);
        ...
        img_spell1_t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkTime[8]) {
                    checkTime[8] = false;
                    setCoolDown(top_spell1, txt_tspell1, (int) champLiine[0].getSpell1id(), 8);
                }
                else {
                    checkTime[8] = true;
                    setCoolDown(top_spell1, txt_tspell1, (int) champLiine[0].getSpell1id(), 8);
        ...
        img_spell2_t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkTime[9]) {
                    checkTime[9] = false;
                    setCoolDown(top_spell2, txt_tspell2, (int) champLiine[0].getSpell2id(), 9);
                }
                else {
                    checkTime[9] = true;
                    setCoolDown(top_spell2, txt_tspell2, (int) champLiine[0].getSpell2id(), 9);
    ...
    void setCoolDown(final LinearLayout setvisible, TextView text, int spell, final int check) {
    ...
    void setChampLine(CurrentData data[]) {
        //챔피언 라인 정하기
        //1. 강타는 무조건 정글(예외. 미드가 강타들수도 있는데..?)
        //2. 탑부터 라인 정하기
        //3. 원딜, 서폿, 탑, 미드 순으로 결정

        int[] pass = new int[]{-1, -1, -1, -1, -1};
